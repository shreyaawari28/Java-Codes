...
This project is intended for beginners to clearly understand how basic mathematical operations work and how variable values change during execution.
...
- Performs and prints results of:
  ...
  - Division
  - Modulus
- Demonstrates **pre-increment** and **pre-decrement** operations
- Demonstrates **compound assignment operators** such as `+=`, `-=`, and `*=`
- Prints results after each operation to observe how values change
